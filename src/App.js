...
function App() {
  ...
  function updateupload(props) {
    setupload(props);
  }
  function handelstatus(username) {
    setloginStatus(true);
  ...
  function handelUserAuth(email, password) {
    auth.createUserWithEmailAndPassword(email, password).catch((error) => {
      alert(error.message);
    });
  }
  function handelSignIn(email, password) {
  ...
  return (
    <div className="App">
      <Header updateUpload={updateupload} islogin={islogin} />
      ...
      {islogin ? (
        ...
        user !== "null" && (
          <Authentication
            upadteStatus={handelstatus}
            handelAuth={handelUserAuth}
      ...
      {isupload && (
        <ImageUpload username={username} updateUpload={updateupload} />
      )}
      {islogin ? (
        <Posts posts={Post} username={username} />
      ) : (
        <div className="display-message flex">
          <svg
      ...
      <Footer updateUpload={updateupload} islogin={islogin} />
    </div>
  );
}
